...
class CtyunStsAdapterFactory implements StsAdapterFactoryInterface
{
    public function make(array $options)
    {
        ...
        $options['accessKeyId'] = $options['accessId'];
        $options['accessKeySecret'] = $options['accessSecret'];
